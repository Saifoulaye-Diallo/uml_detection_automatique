...
from uml_core.models import UMLAttribute, UMLOperation, UMLClass, UMLRelationship, UMLDiagram
from uml_core.grader import UMLGrader, grade_uml_diff
from uml_core.serializer import diagram_to_json, diagram_from_json
...
class TestGrader:
    ...
    def test_multiple_errors(self):
        ...
        diff = {
            ...
            "missing_operations": [],
            "extra_operations": [],
            "missing_relationships": [{"type": "inheritance", "from": "Student", "to": "Person"}],
            "extra_relationships": [],
            "incorrect_multiplicities": [],
            "naming_issues": []
        }
